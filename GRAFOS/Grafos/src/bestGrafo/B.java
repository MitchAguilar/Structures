...
//        GraphAst();
    ...
    private static void GraphAst() {
        GraphCochino thegraph = new GraphCochino(6);
        thegraph.Normalizar();
        ...
        thegraph.addEdge(0, 2, 3);
        thegraph.addEdge(1, 2, 4);
        thegraph.addEdge(2, 3, 7);
        thegraph.addEdge(2, 4, 5);
        thegraph.addEdge(3, 2, 7);
        thegraph.addEdge(3, 4, 3);
        thegraph.addEdge(3, 5, 1);
        thegraph.addEdge(4, 2, 5);
